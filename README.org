...
Upon identification and recording of scattering due to parallel ridges (denoted by 1 in the figure), it moves
 the region of interest by ~90\deg to capture scattering due to cross-ribs (2 in the figure). It then  performs [[http://www.esrf.eu/UsersAndScience/Publications/Highlights/2012/et/et3/][azimuthal integration]] to obtain
a 1D representation of the data, and exports results for ridge spacing and cross-rib spacing in plain text format for posterior analyses.
